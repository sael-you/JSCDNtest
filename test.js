! function(e) {
            ...
            const i = e => { document.getElementById(e).classList.remove("hidden") },
                o = t => !n && (!!XR8.XrDevice.isDeviceBrowserCompatible(t) || ((t => {
                    ...
                    const l = XR8.XrDevice.incompatibleReasons(t),
                        ...
                        u = m && m.content;
                    Array.from(document.querySelectorAll(".app-header-img")).forEach(e => { u ? e.src = u : (e.classList.add("foreground-image"), e.src = "") });
        ...
        const S = (n = !0) => { e.classList.add("hidden"), n && h.parentNode && h.parentNode.removeChild(h) },
            ...
            T = () => {
                ...
                const e = document.querySelector('meta[name="og:image"]'),
                    n = e && e.content;
                Array.from(document.querySelectorAll(".app-header-img")).forEach(e => { n ? e.src = n : (e.classList.add("foreground-image"), e.src = "") });
    ...
    var r = t(4);
    t(38);
    const i = { enableEndCard: !0, footerImageUrl: "" },
        o = {};
    let a, s = !1;
